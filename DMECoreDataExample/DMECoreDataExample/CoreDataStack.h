...
+(CoreDataStack *) coreDataStackWithModelName:(NSString *)aModelName databaseFilename:(NSString*) aDBName;

+(CoreDataStack *) coreDataStackWithModelName:(NSString *)aModelName;

+(CoreDataStack *) coreDataStackWithModelName:(NSString *)aModelName databaseURL:(NSURL*) aDBURL;
